...
const stuff3: number[] | string[] = ['1', '2'];
...
const SkillLevel: 'Beginner' | 'Intermediate' | "Advanced" | "Expert" = "Advanced";
...
const colors: (RGBColor | HSLColor)[] = [{r: 2, g: 3, b: 5}]
...
const greet = (greeting: string | string[]): void => {
